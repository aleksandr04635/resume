        ...
        <div className=" flex flex-col gap-2 mt-2">
          <div>
            ...
            <p>
              ...
              for website creation, from various UI tools to databases and ORMs,
              including testing, with good English.
            </p>
          </div>
          <div className="text-sm">
            <h2 className=" mt-2  text-base font-semibold">My Projects</h2>
            <p>
            ...
            >
              <h3 className="link-stand mt-2  !text-lg font-semibold">
                My Blog
              </h3>
            </Link>
            <div className="text-sm flex flex-col gap-1">
              <p>
                React and Express blog with Mongo/Mongoose DB and extensive use
                of Redux Toolkit Querry with redux-persist for user persistence,
              ...
              <p>
                ...
                email verification and password reset, as well as a commenting
                tree, tags system, voting system, pagination with variable page
                size, and search are implemented.
              </p>
              <p>
            ...
            <div className="text-sm flex flex-col gap-1">
              <p>
                ...
                over this user-created structure is implemented, and over prices
                as well.
              </p>
              <p>
                For authentication Auth.js (Next-Auth V5) is used with options
                of Google and Github OAuth and email-password authentication,
                with emails sending for email verification, password resetting,
                and optional 2-factor authentication.
              </p>
