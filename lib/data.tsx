...
export const mainList = [
  ...
  {
    text: "I'm an expirienced Full-Stack Web Developer with more than a year of teamwork experience, proficient in the full stack of skills, necessary for web apps creation, from various UI tools to databases, with focus on Next.js, with testing skills, and with English on the level C1-C2.",
    textUA:
